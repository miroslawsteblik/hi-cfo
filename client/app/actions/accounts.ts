...
export async function createAccount(
  ...
  try {
    ...
    ErrorLogger.getInstance().logInfo("Account created successfully", {
...
): Promise<{ success: boolean; data?: AccountsResponse; error?: string }> {
  try {
...
export async function getAccount(
  ...
  try {
    ErrorLogger.getInstance().logInfo("Fetching account", {
      context: "get_account",
      accountId: id,
    });
    ...
    ErrorLogger.getInstance().logInfo("Account fetched successfully", {
      context: "get_account",
      accountId: id,
    });
    return { success: true, account };
...
export async function updateAccount(id: string, request: Partial<Account>) {
  try {
    ErrorLogger.getInstance().logInfo("Updating account", {
    ...
    ErrorLogger.getInstance().logInfo("Account updated successfully", {
      context: "update_account",
      accountId: id,
    });
...
export async function deleteAccount(id: string) {
  try {
    ErrorLogger.getInstance().logInfo("Deleting account", {
    ...
    ErrorLogger.getInstance().logInfo("Account deleted successfully", {
      context: "delete_account",
      accountId: id,
    });
    return { success: true };
