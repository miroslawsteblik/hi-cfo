    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {filteredCategories.map((category) => (
          <div key={category.id} className="bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-200 group">
            <div className="p-6">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="flex flex-wrap gap-1">
                            ...
                            {category.keywords.length > 2 && (
                              <span className="text-xs text-gray-500 px-2 py-1">+{category.keywords.length - 2}</span>
                            )}
                          </div>
                        </div>
                      )}
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="flex flex-wrap gap-1">
                            ...
                            {category.merchant_patterns.length > 2 && (
                              <span className="text-xs text-gray-500 px-2 py-1">+{category.merchant_patterns.length - 2}</span>
                            )}
                          </div>
                        </div>
                      )}
